...
(p/set-canvas-pixels! cnvs (p/filter-colors #(c/nearest-color random-palette-6 % v/dist-ang) img))
...
(p/set-canvas-pixels! cnvs (p/filter-colors #(c/nearest-color random-palette-6 % c/delta-E*) img))
(p/set-canvas-pixels! cnvs (p/filter-colors #(c/nearest-color random-palette-6 % c/delta-E*-CMC) img))
(p/set-canvas-pixels! cnvs (p/filter-colors #(c/nearest-color random-palette-6 % c/delta-E*-euclidean) img))
