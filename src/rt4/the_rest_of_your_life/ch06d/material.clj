(ns rt4.the-rest-of-your-life.ch06d.material
  (:require [rt4.common :as common]
            [rt4.the-rest-of-your-life.ch06d.ray :as ray]
            [rt4.the-rest-of-your-life.ch06d.texture :as texture]
            [rt4.the-rest-of-your-life.ch06d.hittable]
...
(defrecord Lambertian [albedo]
  ...
  (scatter [_ ray-in rec]
    (let [scatter-direction (common/random-in-hemisphere (.normal ^HitData rec))
