(ns rt4.the-next-week.ch05d.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch05d.sphere :as sphere]
            [rt4.the-next-week.ch05d.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch05d.camera :as camera]
            [rt4.the-next-week.ch05d.material :as material]
            [rt4.the-next-week.ch05d.scene :as scene]
            [rt4.the-next-week.ch05d.hittable-list :as hittable-list]
            [rt4.the-next-week.ch05d.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch05d.texture :as texture]))
...
(comment
  (common/save image "results/rt4/the_next_week/ch05d.jpg"))
