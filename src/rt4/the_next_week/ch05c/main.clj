(ns rt4.the-next-week.ch05c.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch05c.sphere :as sphere]
            [rt4.the-next-week.ch05c.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch05c.camera :as camera]
            [rt4.the-next-week.ch05c.material :as material]
            [rt4.the-next-week.ch05c.scene :as scene]
            [rt4.the-next-week.ch05c.hittable-list :as hittable-list]
            [rt4.the-next-week.ch05c.bvh :as bvh]
...
(comment
  (common/save image "results/rt4/the_next_week/ch05c.jpg"))
