(ns rt4.the-next-week.ch07b.texture
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [clojure2d.pixels :as p]
            [clojure2d.core :as c2d]
            [rt4.color :as color]
            [rt4.the-next-week.ch07b.perlin :as perlin]
...
(defn checker-texture
  ...
  (let [even (if (instance? Vec3 even) (solid-color even) even)
        odd (if (instance? Vec3 odd) (solid-color odd) odd)]
