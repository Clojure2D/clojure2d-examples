(ns rt4.the-next-week.ch05e.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch05e.sphere :as sphere]
            [rt4.the-next-week.ch05e.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch05e.camera :as camera]
            [rt4.the-next-week.ch05e.material :as material]
            [rt4.the-next-week.ch05e.scene :as scene]
            [rt4.the-next-week.ch05e.hittable-list :as hittable-list]
            [rt4.the-next-week.ch05e.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch05e.texture :as texture]))
...
(comment
  (common/save image "results/rt4/the_next_week/ch05e.jpg"))
