(ns rt4.the-next-week.ch06.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch06.sphere :as sphere]
            [rt4.the-next-week.ch06.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch06.camera :as camera]
            [rt4.the-next-week.ch06.material :as material]
            [rt4.the-next-week.ch06.scene :as scene]
            [rt4.the-next-week.ch06.hittable-list :as hittable-list]
            [rt4.the-next-week.ch06.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch06.texture :as texture]
            [rt4.the-next-week.ch06.quad :as quad]))
...
(def image (time (scene/render (main {:aspect-ratio 1.0} 5))))

(comment
  (common/save image "results/rt4/the_next_week/ch06.jpg"))
