(ns rt4.the-next-week.ch05f.texture
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [clojure2d.pixels :as p]
            [clojure2d.core :as c2d]
            [rt4.color :as color]
            [rt4.the-next-week.ch05f.perlin :as perlin]
...
(defrecord NoiseTexture [noise ^double scale]
  ...
  (value [_ _ _ p]
    ...
    (let [^fastmath.vector.Vec3 s (v/mult p scale)]
      (v/mult one (m/abs (fbm-noise (.x s) (.y s) (.z s)))))))
