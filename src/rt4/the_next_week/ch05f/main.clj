(ns rt4.the-next-week.ch05f.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch05f.sphere :as sphere]
            [rt4.the-next-week.ch05f.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch05f.camera :as camera]
            [rt4.the-next-week.ch05f.material :as material]
            [rt4.the-next-week.ch05f.scene :as scene]
            [rt4.the-next-week.ch05f.hittable-list :as hittable-list]
            [rt4.the-next-week.ch05f.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch05f.texture :as texture]))
...
(comment
  (common/save image "results/rt4/the_next_week/ch05f.jpg"))
