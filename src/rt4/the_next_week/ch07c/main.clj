(ns rt4.the-next-week.ch07c.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch07c.sphere :as sphere]
            [rt4.the-next-week.ch07c.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch07c.camera :as camera]
            [rt4.the-next-week.ch07c.material :as material]
            [rt4.the-next-week.ch07c.scene :as scene]
            [rt4.the-next-week.ch07c.hittable-list :as hittable-list]
            [rt4.the-next-week.ch07c.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch07c.texture :as texture]
            [rt4.the-next-week.ch07c.quad :as quad]))
...
(comment
  (common/save image "results/rt4/the_next_week/ch07c.jpg"))
