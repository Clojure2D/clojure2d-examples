(ns rt4.the-next-week.ch08a.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch08a.sphere :as sphere]
            [rt4.the-next-week.ch08a.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch08a.camera :as camera]
            [rt4.the-next-week.ch08a.material :as material]
            [rt4.the-next-week.ch08a.scene :as scene]
            [rt4.the-next-week.ch08a.hittable-list :as hittable-list]
            [rt4.the-next-week.ch08a.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch08a.texture :as texture]
            [rt4.the-next-week.ch08a.quad :as quad]))
...
(defn cornell-box [scene-def]
  (let [camera (camera/camera (assoc default-camera-def
        ...
        world (-> (hittable-list/hittable-list (quad/quad (v/vec3 555 0 0) (v/vec3 0 555 0)
                  ...
                  (hittable-list/merge-hittable-lists (quad/box (v/vec3 130 0 65) (v/vec3 295 165 230) white))
                  (hittable-list/merge-hittable-lists (quad/box (v/vec3 265 0 295) (v/vec3 430 330 460) white)))]
    (scene/scene camera (bvh/bvh-node world) scene-def)))
...
(comment
  (common/save image "results/rt4/the_next_week/ch08a.jpg"))
