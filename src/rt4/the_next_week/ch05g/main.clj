(ns rt4.the-next-week.ch05g.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch05g.sphere :as sphere]
            [rt4.the-next-week.ch05g.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch05g.camera :as camera]
            [rt4.the-next-week.ch05g.material :as material]
            [rt4.the-next-week.ch05g.scene :as scene]
            [rt4.the-next-week.ch05g.hittable-list :as hittable-list]
            [rt4.the-next-week.ch05g.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch05g.texture :as texture]))
...
(comment
  (common/save image "results/rt4/the_next_week/ch05g.jpg"))
