(ns rt4.the-next-week.ch04a.main
  (:require [fastmath.core :as m]
            ...
            [rt4.the-next-week.ch04a.scene :as scene]
            [rt4.the-next-week.ch04a.hittable-list :as hittable-list]
            [rt4.the-next-week.ch04a.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch04a.texture :as texture]))
...
(def checker (texture/color-checker-texture 0.32 (v/vec3 0.2 0.3 0.1) (v/vec3 0.9 0.9 0.9)))
(def ground-material (material/lambertian checker))
...
(comment
  (common/save image "results/rt4/the_next_week/ch04a.jpg"))
