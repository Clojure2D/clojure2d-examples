(ns rt4.the-next-week.ch07a.main
  (:require [fastmath.core :as m]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.the-next-week.ch07a.sphere :as sphere]
            [rt4.the-next-week.ch07a.moving-sphere :as moving-sphere]
            [rt4.the-next-week.ch07a.camera :as camera]
            [rt4.the-next-week.ch07a.material :as material]
            [rt4.the-next-week.ch07a.scene :as scene]
            [rt4.the-next-week.ch07a.hittable-list :as hittable-list]
            [rt4.the-next-week.ch07a.bvh :as bvh]
            [fastmath.random :as r]
            [rt4.the-next-week.ch07a.texture :as texture]
            [rt4.the-next-week.ch07a.quad :as quad]))
...
(def image (time (scene/render (main {:background (v/vec3 0.0 0.0 0.0)} 0))))

(comment
  (common/save image "results/rt4/the_next_week/ch07a.jpg"))
