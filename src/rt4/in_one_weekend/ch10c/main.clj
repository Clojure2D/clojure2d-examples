(ns rt4.in-one-weekend.ch10c.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch10c.hittable :as hittable]
            [rt4.in-one-weekend.ch10c.sphere :as sphere]
            [rt4.in-one-weekend.ch10c.interval :as interval]
            [rt4.in-one-weekend.ch10c.camera :as camera]
            [rt4.in-one-weekend.ch10c.material :as material]
            [rt4.color :as color]
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch10c.jpg"))
