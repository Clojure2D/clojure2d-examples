(ns rt4.in-one-weekend.ch10b.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch10b.hittable :as hittable]
            [rt4.in-one-weekend.ch10b.sphere :as sphere]
            [rt4.in-one-weekend.ch10b.interval :as interval]
            [rt4.in-one-weekend.ch10b.camera :as camera]
            [rt4.in-one-weekend.ch10b.material :as material]
            [rt4.color :as color]
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch10b.jpg"))
