(ns rt4.in-one-weekend.ch09b.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch09b.hittable :as hittable]
            [rt4.in-one-weekend.ch09b.sphere :as sphere]
            [rt4.in-one-weekend.ch09b.interval :as interval]
            [rt4.in-one-weekend.ch09b.camera :as camera]
            [rt4.in-one-weekend.ch09b.material :as material]
            [rt4.color :as color]
...
(def material-left (material/metal (v/vec3 0.8 0.8 0.8) 0.3))
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch09b.jpg"))
