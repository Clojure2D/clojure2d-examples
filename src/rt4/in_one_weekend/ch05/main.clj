(ns rt4.in-one-weekend.ch05.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [clojure2d.color :as c]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch05.ray :as ray])
...
(def red (v/vec3 1.0 0.0 0.0))

(defn hit-sphere? [center ^double radius r]
...
(defn ray-color [r]
  (if (hit-sphere? sphere-position 0.5 r)
    red
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch05.jpg"))
