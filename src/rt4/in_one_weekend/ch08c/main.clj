(ns rt4.in-one-weekend.ch08c.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch08c.hittable :as hittable]
            [rt4.in-one-weekend.ch08c.sphere :as sphere]
            [rt4.in-one-weekend.ch08c.interval :as interval]
            [rt4.in-one-weekend.ch08c.camera :as camera]
...
(defn ray-color [r world ^long depth]
  (if (zero? depth)
    ...
    (if-let [rec (hittable/hit-list world r (interval/interval 0.001 ##Inf))]
      (let [direction (v/add (:normal rec) (common/random-unit-vector))]
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch08c.jpg"))
