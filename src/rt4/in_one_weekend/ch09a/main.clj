(ns rt4.in-one-weekend.ch09a.main
  (:require [fastmath.core :as m]
            [clojure2d.pixels :as p]
            [fastmath.vector :as v]
            [rt4.common :as common]
            [rt4.in-one-weekend.ch09a.hittable :as hittable]
            [rt4.in-one-weekend.ch09a.sphere :as sphere]
            [rt4.in-one-weekend.ch09a.interval :as interval]
            [rt4.in-one-weekend.ch09a.camera :as camera]
            [rt4.in-one-weekend.ch09a.material :as material]
            [rt4.color :as color]
...
(def material-center (material/lambertian (v/vec3 0.7 0.3 0.3)))
(def material-left (material/metal (v/vec3 0.8 0.8 0.8)))
(def material-right (material/metal (v/vec3 0.8 0.6 0.2)))
...
(comment
  (common/save image "results/rt4/in_one_weekend/ch09a.jpg"))
